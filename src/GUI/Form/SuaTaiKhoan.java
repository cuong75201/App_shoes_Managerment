...
public class SuaTaiKhoan extends JFrame{
     TaiKhoanBLL tk;
    int width = 490, height = 600;
    JPanel panelTop, pnContent;
    JLabel lbtitle;
    public customTextField faccount;
    JLabel lbaccount, lbcapbac, lbhoatdong;
